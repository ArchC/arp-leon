...
public:
  ...
  bool direct_read(uint32_t &, uint32_t &);
  bool direct_write(uint32_t &, uint32_t &);
  /**
  ...
  */
   ...
   * 
   * @param i Memory start address size in bytes.
   * @param k Memory end address size in bytes.
   */
  ac_tlm_mem( sc_module_name module_name , unsigned int i, unsigned int k );

  /** 
   * Default constructor.
   * 
   * @param k Memory size in bytes
   * 
   */
  ac_tlm_mem( sc_module_name module_name , unsigned int size );
  /** 
   * Default destructor.
   */
  ~ac_tlm_mem();
